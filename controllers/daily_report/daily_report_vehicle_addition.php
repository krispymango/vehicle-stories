...
//vehicle_addition_report
$sql_va = "SELECT * FROM vw_dr_vehicle_addition";
...
if ($sql_va_exec)
{
  $message_vehicle_addition_header = "
  <h4 style='text-align:center;'>New vehicle addition daily report</h4><table>
      <thead>
      <th>id</th>
    <th>username</th>
...
{
  $message_vehicle_addition_body .=
        "<tr>
          td>".$a++."</td>
          <td>".$sql_va_fetch['username']."</td>
          <td>".$sql_va_fetch['date_of_addition']."</td>
          <td>".$sql_va_fetch['time_of_addition']."</td>
          <td>".$sql_va_fetch['brand']."</td>
        </tr>";
}
$message_vehicle_addition_footer = "
    </tbody>
    </table>
    <br>";
}
