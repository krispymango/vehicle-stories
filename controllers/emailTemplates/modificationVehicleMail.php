...
$sql = "SELECT * FROM vs_user WHERE id = '$_SESSION[id]' AND email = '$_SESSION[email]'";
...
{
  $message_change = str_replace("[username]",$name,$sql_et_fetch['vehicle_modifications']);
...
$mail = new PHPMailer(true);
 ...
 //$mail->SMTPDebug = 4;                               // Enable verbose debug output
  ...
  $mail->setFrom(EMAIL, 'Vehicle Stories Vehicle Modification');
...
/*
  ...
  */
  ...
  $mail->Subject = 'Modification of vehicle';
