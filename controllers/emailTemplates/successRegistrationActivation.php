...
{
  $message_change = str_replace("[username]",$name,$sql_et_fetch['successful_activation']);
 ...
 //$mail->SMTPDebug = 4;                               // Enable verbose debug output
  ...
  $mail->setFrom(EMAIL, 'Vehicle Stories Successful Activation');
...
/*
  ...
  */
  ...
  $mail->Subject = 'Account Acctivation Success Message';
