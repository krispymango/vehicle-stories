...
<?php $_SESSION['edit_id'] = base64_decode(hex2bin($_GET['id'])); ?>
...
<form class="edit_vehicle_form" action="<?php echo BASE_URL . '/app/helpers/editVehicle'; ?>" method="post" enctype="multipart/form-data">

  <input type="hidden" name="u_id" value="<?php echo $_GET['u_id']; ?>">
  <input type="hidden" name="admin_allow" value="<?php echo $_GET['admin_allow']; ?>">
  ...
  <div class="add_vehicle_form_grid">
    ...
    <select name="type_of_vehicle" id="tov_cat" required>
      <?php EditTypeOfVehicle(); ?>
    ...
    <input class="yearpicker" type="text" name="year_of_production" <?php
    ...
    if ($sql_ed_exec)
    {
     echo "value='".$sql_ed_fetch['year_of_production']."'";
    } ?>  required>
    </div>

    <div>
    <label>Engine Capacity:</label>
    <input type="text" name="engine_capacity" value="
    <?php
    $edit_id = base64_decode(hex2bin($_GET['id']));
    $u_id = base64_decode(hex2bin($_GET['u_id']));
    $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
    ...
    if ($sql_ed_exec)
    {
     echo $sql_ed_fetch['engine_capacity'];
    } ?>" >
    </div>

    <div>
    <label>Power:</label>
    <input type="text" name="engine_power" value="
    <?php
    $edit_id = base64_decode(hex2bin($_GET['id']));
    $u_id = base64_decode(hex2bin($_GET['u_id']));
    $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
    ...
    if ($sql_ed_exec)
    {
     echo $sql_ed_fetch['engine_power'];
    } ?>">
    </div>
    <!-- first row -->
   ...
   <option value="petrol">petrol</option>
    ...
    <input type="number" name="max_speed" min="0" maxlength="10" value="<?php EditMaxSpeed();?>">
    </div>
  ...
  <input type="text" name="mileage" value="<?php
  ...
  if ($sql_ed_exec)
  {
   echo $sql_ed_fetch['country_of_origin'];
  } ?>"><?php
  $edit_id = base64_decode(hex2bin($_GET['id']));
  $u_id = base64_decode(hex2bin($_GET['u_id']));
  $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
  ...
  <input type="text"  name="estimated_value" value="
  <?php
  $edit_id = base64_decode(hex2bin($_GET['id']));
  $u_id = base64_decode(hex2bin($_GET['u_id']));
  $sql_edd = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
  $sql_edd_exec = mysqli_query($conn,$sql_edd);
  $sql_edd_fetch = mysqli_fetch_assoc($sql_edd_exec);

  if ($sql_edd_fetch)
  {
   echo $sql_edd_fetch['estimated_value'];
  } ?>" >
  </div>
  <div>
  <label>Year of Purchase by current owner:</label>
  <input class="yearpicker" type="number" name="y_o_p_b_c_o" value="<?php
  $edit_id = base64_decode(hex2bin($_GET['id']));
  $u_id = base64_decode(hex2bin($_GET['u_id']));
  $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
  $sql_ed_exec = mysqli_query($conn,$sql_ed);
  ...
  if ($sql_ed_exec)
  {
   echo $sql_ed_fetch['y_o_p_b_c_o'];
  } ?>" required>
  </div>
  <div>
  <label><span style="color:red;">*</span> Location - voivodship:</label>
  <select type="text" name="location_voivodship" required>
    <option value="
    <?php
    $edit_id = base64_decode(hex2bin($_GET['id']));
    $u_id = base64_decode(hex2bin($_GET['u_id']));
    ...
    if ($sql_ed_exec)
    {
     echo $sql_ed_fetch['location_voivodship'];
    } ?>"><?php
    $edit_id = base64_decode(hex2bin($_GET['id']));
    $u_id = base64_decode(hex2bin($_GET['u_id']));
    $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
  ...
  <option value="<?php
    ...
    if ($sql_ed_exec)
    {
     echo $sql_ed_fetch['location_district'];
    } ?>">
    <?php
    $edit_id = base64_decode(hex2bin($_GET['id']));
    $u_id = base64_decode(hex2bin($_GET['u_id']));
  ...
  <div>
    ...
    <textarea name="d_o_v_c" rows="8" cols="80">
    <?php
    $edit_id = base64_decode(hex2bin($_GET['id']));
    $u_id = base64_decode(hex2bin($_GET['u_id']));
    $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
    ...
    if ($sql_ed_exec)
    {
     echo $sql_ed_fetch['d_o_v_c'];
    } ?></textarea>
  </div>

  <div>
  <label>History and origin of the vehicle:</label>
  <textarea name="h_a_o_o_v" rows="8" cols="80">
    <?php
    $edit_id = base64_decode(hex2bin($_GET['id']));
    $u_id = base64_decode(hex2bin($_GET['u_id']));
    $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
  ...
  <textarea name="s_v_h_t_p" rows="8" cols="80">
    <?php
    $edit_id = base64_decode(hex2bin($_GET['id']));
    $u_id = base64_decode(hex2bin($_GET['u_id']));
    $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
  ...
  <textarea name="u_a_e_o_v" rows="8" cols="80">
    ...
    if ($sql_ed_exec)
    {
     echo $sql_ed_fetch['u_a_e_o_v'];
    } ?></textarea>
  </div>
  <div>
  <label>Interesting or pleasant events linked to the vehicle:</label>
  <textarea name="i_e_l_t_t_v" rows="8" cols="80">
    <?php
    $edit_id = base64_decode(hex2bin($_GET['id']));
    $u_id = base64_decode(hex2bin($_GET['u_id']));
    $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
    ...
    if ($sql_ed_exec)
    {
     echo $sql_ed_fetch['i_e_l_t_t_v'];
    } ?></textarea>
  </div>
  <div>
  <label>The advantages of the vehicle:</label>
  <textarea name="advantages_of_vehicle" rows="8" cols="80">
    <?php
    $edit_id = base64_decode(hex2bin($_GET['id']));
    $u_id = base64_decode(hex2bin($_GET['u_id']));
    $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
    ...
    if ($sql_ed_exec)
    {
     echo $sql_ed_fetch['advantages_of_vehicle'];
    } ?></textarea>
  </div>
  <div>
  <label>Problems with the vehicle, repairs, maintenance:</label>
  <textarea name="problems_with_vehicle" rows="8" cols="80">
    <?php
    $edit_id = base64_decode(hex2bin($_GET['id']));
    $u_id = base64_decode(hex2bin($_GET['u_id']));
    $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
    ...
    if ($sql_ed_exec)
    {
     echo $sql_ed_fetch['problems_with_vehicle'];
    } ?></textarea>
  </div>
  <div>
  <label>Announcement - buy, sell, trade, give away:</label>
  <textarea name="announcement" rows="8" cols="80">
    <?php
    $edit_id = base64_decode(hex2bin($_GET['id']));
    $u_id = base64_decode(hex2bin($_GET['u_id']));
    $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
    ...
    if ($sql_ed_exec)
    {
     echo $sql_ed_fetch['announcement'];
    } ?></textarea>
  </div>
  <div>
  <label>Add a photo of the main vehicle:</label>
  <br>
  <div class="edit_div">
 <input type="file" name="main_photo" class="custom-file-input"
    onchange="readURLMainPhoto(this);"
    accept="image/png, image/gif, image/jpeg">
    <br>
    <img id="imgMainPhoto" style="width:200px;height:200px;object-fit:contain;" <?php
       $edit_id = base64_decode(hex2bin($_GET['id']));
       $u_id = base64_decode(hex2bin($_GET['u_id']));
       $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
       $sql_ed_exec = mysqli_query($conn,$sql_ed);
       ...
       if ($sql_ed_exec && !empty($sql_ed_fetch['photo_one']))
       {
      echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['main_photo']."'";
       } ?>>
       <br>
...
<input title="Choose an image" class="custom-file-input" type="file" onchange="readURLOne(this);" accept="image/png, image/gif, image/jpeg" name="photo_one">
<div  id="imggOne">
  <img id="imgOne" style="width:200px;height:200px;object-fit:contain;" <?php
     $edit_id = base64_decode(hex2bin($_GET['id']));
     $u_id = base64_decode(hex2bin($_GET['u_id']));
     $sql_ed = "SELECT * FROM vw_vehicle_details WHERE id = '$edit_id' AND user_id = '$u_id'";
     $sql_ed_exec = mysqli_query($conn,$sql_ed);
     ...
     if ($sql_ed_exec && !empty($sql_ed_fetch['photo_one']))
     {
    echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_one']."'";
     } ?>>
...
<div class="edit_div">
  ...
  <input class="custom-file-input" type="file" onchange="readURLTwo(this);" accept="image/png, image/gif, image/jpeg" name="photo_two">
<div  id="imggTwo">
    <img <?php
       $edit_id = base64_decode(hex2bin($_GET['id']));
       $u_id = base64_decode(hex2bin($_GET['u_id']));
       ...
       if ($sql_ed_exec && !empty($sql_ed_fetch['photo_two']))
       {
      echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_two']."'";
    } ?> style="width:200px;height:200px;object-fit:contain;"id="imgTwo">
...
<div class="edit_div">
  ...
  <input class="custom-file-input" type="file" name="photo_three" onchange="readURLThree(this);" accept="image/png, image/gif, image/jpeg">
  <div id="imggThree">
<img <?php
   $edit_id = base64_decode(hex2bin($_GET['id']));
   $u_id = base64_decode(hex2bin($_GET['u_id']));
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_three']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_three']."'";
   } ?>  style="width:200px;height:200px;object-fit:contain;"id="imgThree">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_four']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_four']."'";
   } ?>  style="width:200px;height:200px;object-fit:contain;"id="imgFour">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_five']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_five']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgFive">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_six']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_six']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgSix">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_seven']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_seven']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgSeven">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_eight']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_eight']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgEight">
...
<div  id="imggNine">
  <img <?php
     ...
     if ($sql_ed_exec && !empty($sql_ed_fetch['photo_nine']))
     {
    echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_nine']."'";
     } ?> style="width:200px;height:200px;object-fit:contain;"id="imgNine">
...
<div  id="imggTen">
  <img <?php
     ...
     if ($sql_ed_exec && !empty($sql_ed_fetch['photo_ten']))
     {
    echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_ten']."'";
     } ?> style="width:200px;height:200px;object-fit:contain;"id="imgTen">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_eleven']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_eleven']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgEleven">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_twelve']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_twelve']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgTwelve">
...
<img  <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_thirteen']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_thirteen']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgThirteen">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_fourteen']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_fourteen']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgFourteen">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_fifteen']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_fifteen']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgFifteen">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_sixteen']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_sixteen']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgSixteen">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_seventeen']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_seventeen']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgSeventeen">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_eighteen']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_eighteen']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgEighteen">
...
<img <?php
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_nineteen']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_nineteen']."'";
   } ?> style="width:200px;height:200px;object-fit:contain;"id="imgNineteen">
<input name="caption_photo_nineteen" style="width: 90%;margin-top:1vh;margin-bottom:4vh;" type="text" placeholder="Add a Caption to image (optional)">
  ...
  <div class="edit_div">
<input class="custom-file-input" type="file" name="photo_twenty" accept="image/png, image/gif, image/jpeg" onchange="readURLTwenty(this);"/>
<div  id="imggTwenty">
<img <?php
   $edit_id = base64_decode(hex2bin($_GET['id']));
   $u_id = base64_decode(hex2bin($_GET['u_id']));
   ...
   if ($sql_ed_exec && !empty($sql_ed_fetch['photo_twenty']))
   {
  echo "src='". BASE_URL ."/assets/img/CarPhotos/".$sql_ed_fetch['photo_twenty']."'";
} ?> style="width:200px;height:200px;object-fit:contain;"id="imgTwenty">
