...
{
  $message_change = str_replace("[username]",$name,$sql_et_fetch['success_email_change_new']);
 ...
 //$mail->SMTPDebug = 4;                               // Enable verbose debug output
  ...
  $mail->setFrom(EMAIL, 'Vehicle Stories Successful Password Change');
...
/*
  ...
  */
  ...
  $mail->Subject = 'Password Acctivation Success Message';
