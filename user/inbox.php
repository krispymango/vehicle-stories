...
if (isset($_GET['read']))
{
  $sql = "UPDATE vs_messages SET read_msg = 0 WHERE receiver_id = '$_SESSION[id]'";
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Vehicle Stories | Message</title>
    ...
    <script src="<?php echo BASE_URL . "/assets/js/messageFunctionality.js";?>"></script>
  </head>
  <body>
    <!-- Navigation bar -->
  ...
  <?php include(ROOT_PATH . "/app/includes/mobileHeaderContent.php"); ?>
    <!-- Navigation bar -
    <!--slider carousel-->
<?php include(ROOT_PATH . "/user/includes/userMessageContent.php"); ?>
    <!--slider carousel-->
