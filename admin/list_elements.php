...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL . "/assets/css/webkit.css"; ?>">
    <link rel="stylesheet" href="<?php echo BASE_URL . "/assets/css/all.min.css"; ?>">
    <script src="<?php echo BASE_URL . "/assets/js/jquery.min.js";?>"></script>
    <script src="<?php echo BASE_URL . "/assets/js/adminJs.js";?>"></script>
...
<?php include(ROOT_PATH . "/admin/includes/adminHeaderContent.php"); ?>
    ...
    <!--slider carousel-->
<?php include(ROOT_PATH . "/admin/includes/adminListElementsContent.php"); ?>
    <!--slider carousel-->
